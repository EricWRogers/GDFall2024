...
public class TriangleKeyDoor : MonoBehaviour
{
    public TriangleKey playerTriangleKeyScript;  // Reference to the player's TriangleKey script
    ...
    private void Update()
    {
        ...
        if (player != null && playerTriangleKeyScript != null)
        {
            ...
            // Check if the player is within range and has the Triangle Key
            if (distanceToDoor <= interactionRange && playerTriangleKeyScript.hasTriangleKey)
            {
    ...
    void OpenDoor()
    {
        ...
        Debug.Log("The Triangle Key Door is now open.");
        ...
        if (doorCollider != null)
        {
            ...
            Debug.Log("The Triangle Key Door's collider has been removed.");
        }
