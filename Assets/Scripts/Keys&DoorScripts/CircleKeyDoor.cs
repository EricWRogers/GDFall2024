...
public class CircleKeyDoor : MonoBehaviour
{
    public CircleKey playerCircleKeyScript;  // Reference to the player's CircleKey script
    ...
    private void Update()
    {
        ...
        if (player != null && playerCircleKeyScript != null)
        {
            ...
            // Check if the player is within range and has the Circle Key
            if (distanceToDoor <= interactionRange && playerCircleKeyScript.hasCircleKey)
            {
    ...
    void OpenDoor()
    {
        ...
        Debug.Log("The Circle Key Door is now open.");
        ...
        if (doorCollider != null)
        {
            ...
            Debug.Log("The Circle Key Door's collider has been removed.");
        }
